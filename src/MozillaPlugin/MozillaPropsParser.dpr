{@abstract(Mozilla Messenger messenger.properties parser project file) }
{
...
// $Id: MozillaPropsParser.dpr 13 2006-07-12 14:30:20Z peter3 $
...
begin
  Parser := TMozillaPropsParser.Create;
  Result := S_OK;
end;
